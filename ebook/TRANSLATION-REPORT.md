...
18–19 August 2026. This is a working draft of a whole *Odyssey*, not a claim that it is the best English *Odyssey*. The work was done as rigorously as the time allowed, and the thin spots are named.
...
**Working formats in this repository**
- English: `english/book-01.md` … `english/book-24.md` — speaker tags and `N<TAB>line`
- Builder: `scripts/build_ebook.py`
- Jacket: `cover/cover-exact.jpg`

---

## 3. Lessons and limits
...
- Write-protecting a finished book so it did not get overwritten.

**What is thin**
- There was no full second reading of all 12,107 lines against the Greek after the first draft. That is the largest quality risk.
...
- One book at a time, lock immediately.
- A short loaded-word glossary before Book 1.
- A review pass especially on Books 4, 8–16, and 24.
- Run `epubcheck`.
